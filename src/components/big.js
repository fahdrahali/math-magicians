...
(function (GLOBAL) {
  ...
  /*
     ...
     */
  const RM = 1; // 0, 1, 2 or 3

  // The maximum value of DP and Big.DP.
  const MAX_DP = 1E6; // 0 to 1000000

  // The maximum magnitude of the exponent argument to the pow method.
  const MAX_POWER = 1E6; // 1 to 1000000
  ...
  */
  ...
  P.div = function (y) {
    ...
    let bl; let bt; let n; let cmp; let ri;
    const bz = b.slice();
    let ai = bl = b.length;
    const al = a.length;
    ...
    const qc = q.c = [];
    let qi = 0;
    const d = dp + (q.e = x.e - y.e) + 1; // number of digits of the result
